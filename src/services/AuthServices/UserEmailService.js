...
const sendResetPasswordEmail = async (email, token) => {
  try {
    ...
    const mailOptions = {
      from: `"Suporte LIBRA" <${process.env.EMAIL_USER}>`,
      to: email,
      subject: "Redefinição de Senha - LIBRA",
      html: `
        <!DOCTYPE html>
        <html lang="pt-BR">
        <head>
            ...
            <title>Redefinição de Senha - LIBRA</title>
            <style>
        ...
        <body>
            <div class="email-wrapper">
                <div class="email-container">
                    ...
                    <div class="content">
                        <h2>Olá,</h2>
                        <p class="info-text">Recebemos uma solicitação para redefinir a senha da sua conta <span class="highlight">LIBRA</span>. Para continuar com o processo, clique no botão abaixo:</p>
